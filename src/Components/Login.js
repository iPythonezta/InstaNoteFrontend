                ...
                </Navbar>
                {
                    loading && (
                        <Container className="d-flex justify-content-center align-items-center" style={{ height: '80vh', marginTop:'-50px' }}>
                            <Spinner animation="border" variant="primary" color='red' style={{height:'100px', width:'100px'}} />
                        </Container>
                    )
                }
                {!loading &&(<Container className="d-flex justify-content-center align-items-center" style={{ height: '80vh', marginTop:'-50px' }}>
